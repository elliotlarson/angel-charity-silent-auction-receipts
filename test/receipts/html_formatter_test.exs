defmodule Receipts.HtmlFormatterTest do
  ...
  describe "format_description/1" do
    ...
    test "converts http URLs to links" do
      ...
      expected =
        "<p>Visit <a href=\"http://example.com\">http://example.com</a> for more info</p>"
    ...
    test "converts https URLs to links" do
      ...
      expected =
        "<p>Redeem at <a href=\"https://redeem.travelpledge.com/T42825\">https://redeem.travelpledge.com/T42825</a></p>"
