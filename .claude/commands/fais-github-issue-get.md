---
argument-hint: [story-path|story|this] [issue-id]
description: Download GitHub issue into a fais story
---
...
Then, if $2 is provided, use it as the issue ID to download.

Then: Can you read {storiesDir}/.fais/context/\*.md, {full-story-path}, and follow instructions from
{storiesDir}/.fais/jobs/github/issue/get.md
